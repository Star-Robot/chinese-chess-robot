...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='yolov7-tiny.weights', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='yolov7-tiny.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/chess.yaml', help='data.yaml path')
